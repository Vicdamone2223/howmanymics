...
// If you prefer to skip prerendering entirely instead of Suspense, uncomment:
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // pass the string code (not an object)
    ...
    <main className="mx-auto max-w-md px-4 py-10">
      ...
      <div className="mt-6 text-xs opacity-70 space-y-1">
        <p>
          ...
          <b>{typeof window !== 'undefined' ? window.location.origin : 'http://localhost:3000'}</b>.
        </p>
...
export default function Page() {
  return (
    <Suspense
      fallback={
        <main className="mx-auto max-w-md px-4 py-10">
          <div className="opacity-80 text-sm">Loading…</div>
        </main>
      }
    >
      <LoginInner />
